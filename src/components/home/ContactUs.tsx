...
const ContactUs = () => {
	...
	return (
    <div className="z-1 relative mx-auto -mb-40 flex h-96 w-11/12 flex-col items-center justify-center rounded-lg bg-primaryGreen px-3 text-center text-primaryBlack md:w-4/5 lg:block lg:pt-20">
